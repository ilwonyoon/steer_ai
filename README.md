...
<p align="center">
  <a href="https://github.com/ilwonyoon/steer_ai/releases/latest/download/Steer-0.1.4.dmg">
...
Early dogfooding. iPhone companion is in progress; today's [`v0.1.4` release](https://github.com/ilwonyoon/steer_ai/releases/tag/v0.1.4) is Mac-only. See [`EXECUTION_PLAN.md`](EXECUTION_PLAN.md) for the active backlog.
