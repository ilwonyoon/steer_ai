...
#ifndef STEERMAC_SWIFT_H
#define STEERMAC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SteerMac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// at build time.
/// Enablement is keyed off <code>SparkleEnabled</code> in Info.plist. Local dogfood
/// builds can leave it <code>NO</code> to skip the update check entirely; release
/// builds set it <code>YES</code> and ship <code>SUFeedURL</code> + <code>SUPublicEDKey</code> alongside.
SWIFT_CLASS("_TtC8SteerMac17SparkleController")
@interface SparkleController : NSObject
...
@class NSApplication;
SWIFT_CLASS("_TtC8SteerMac16SteerAppDelegate")
@interface SteerAppDelegate : NSObject <NSApplicationDelegate, NSMenuDelegate>
