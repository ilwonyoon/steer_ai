...
/// iOS port of Mac DetailView. Same Back / project · provider · state
/// header, terminal-tail panel, thread bubbles, ReplyDock at bottom.
struct DetailView: View {
    ...
    var body: some View {
        ...
        .background(SteerColors.appBackground.ignoresSafeArea())
    }
}
